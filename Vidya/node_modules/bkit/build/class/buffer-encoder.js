...
class BufferEncoder {
	...
	writerIntLE(nb_write) {
		...
		switch(nb_write) {
			...
			case 2: return (x_value) => {
				let ib_write = this._ib_write;
				let at_contents = this._at_contents;

				// write exceeds current buffer; grow
				if(ib_write + 2 > at_contents.length) {
			...
			case 3: return (x_value) => {
				...
				// write exceeds current buffer; grow
				if(ib_write + 3 > at_contents.length) {
					at_contents = BufferEncoder$grow(this);
				}
			...
			case 4: return (x_value) => {
				let ib_write = this._ib_write;
				let at_contents = this._at_contents;

				// write exceeds current buffer; grow
				if(ib_write + 4 > at_contents.length) {
					at_contents = BufferEncoder$grow(this);
				}
			...
			case 5: return (x_value) => {
				let ib_write = this._ib_write;
				let at_contents = this._at_contents;

				// write exceeds current buffer; grow
				if(ib_write + 5 > at_contents.length) {
					at_contents = BufferEncoder$grow(this);
				}
			...
			case 6: return (x_value) => {
				let ib_write = this._ib_write;
				let at_contents = this._at_contents;

				// write exceeds current buffer; grow
				if(ib_write + 6 > at_contents.length) {
					at_contents = BufferEncoder$grow(this);
				}
